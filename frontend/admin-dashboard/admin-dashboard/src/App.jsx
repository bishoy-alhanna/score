          ...
          <TabsContent value="groups">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage groups and team structures</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="scoring">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Assign and manage scores</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">Scoring system coming soon...</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
